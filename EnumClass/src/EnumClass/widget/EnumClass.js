/*
    v1.3.0 - 25-01-2021 - Ivo Sturm -  Added support for option where user selects attributeType = 'reference', but doesn't select a reference but only an enum attribute of the entity itself
*/
...
define([
  ...
  return declare("EnumClass.widget.EnumClass", [_WidgetBase], {
    ...
    update : function (obj, callback) {
      ...
      if (obj) {
        ...
        if (this.elementToApplyTo) {
          ...
          // v1.3.0 add support for enum attribute of context entity itself
          else if (!this.referenceEntity && this.name){
    ...
    _setValueAttr : function (value) {
      // v1.3.0 add support for enum attribute of context entity itself, so excluding entities selected over reference here...
